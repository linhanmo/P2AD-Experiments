_base_ = [
    '/root/rivermind-data/PoseBH/configs/_base_/default_runtime.py',
    '/root/rivermind-data/PoseBH/configs/_base_/datasets/coco.py',
]
...
lr_config = dict(policy='step', warmup='linear', warmup_iters=200, warmup_ratio=0.001, step=[6, 8])
total_epochs = 10

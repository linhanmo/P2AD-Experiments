...
prune_hook = dict(
    ...
    prune_step_ratio=0.10,
    max_prune_ratio=0.60,
    max_prune_ratio_stage3={0: 0.112, 1: 0.40, 2: 0.743},
    max_prune_ratio_stage4={0: 0.112, 1: 0.40, 2: 0.743, 3: 0.743},
    post_switch_ratio=0.5,
    post_step_ratio=0.05,
    step_schedule=(
        dict(until=0.5, step=0.10),
        dict(until=1.0, step=0.05),
    ),
    round_to=16,
    branch_weight_stage3=(0.25, 0.6, 1.0),
    branch_weight_stage4=(0.2, 0.5, 0.8, 1.0),
    min_ap_drop=0.0015,
    recover_margin=0.0,
    recover_drop_tolerance=0.0015,
    recovery_schedule_base_ap=0.7600,
    recovery_schedule_drop_per_10p=0.0,
    recovery_schedule_ratio_unit=0.1,
    use_ratio_based_recovery=False,
...
custom_hooks = [state_hook, prune_hook]
